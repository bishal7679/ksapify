...
var getObjectDeploymentsCmd = &cobra.Command{
	Use:   "deployments",
...
ksapify get deployments <use available flags>`,
...
func init() {
	getObjectDeploymentsCmd.Flags().StringVarP(&Clusterns, "namespace", "n", "", "Namespace name")
	getObjectDeploymentsCmd.Flags().StringVarP(&Output, "output", "o", "", "Output type [json/yaml]")
	getObjectDeploymentsCmd.Flags().BoolVarP(&Wide, "wide", "w", false, "Wider output [true/false]")
	GetobjectCmd.AddCommand(getObjectDeploymentsCmd)
